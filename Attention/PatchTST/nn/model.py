...
class PatchSRT(nn.Module):
    def __init__(self, n_token, input_dim, model_dim, num_heads, num_layers, output_dim, dim_feedforward=256):
        ...
        self.res_layer_1 = nn.Linear(input_dim, model_dim*2) # 512
        self.res_layer_2 = nn.Linear(model_dim*2, model_dim*4) # 1024
        self.res_layer_3 = nn.Linear(model_dim*4, input_dim)
